...
if(IDA_SDK_FOUND)
	...
	if(WIN32)
		if(EA64)
			...
			set(IDA_SDK_LIBS "${IDA_SDK_SOURCE_ROOT}/lib/x64_win_vc_32/ida.lib")
		endif()
	else()
		if(EA64)
			set(IDA_SDK_LIBS "${IDA_SDK_SOURCE_ROOT}/lib/x64_linux_gcc_64/libida64.so")
		else()
			set(IDA_SDK_LIBS "${IDA_SDK_SOURCE_ROOT}/lib/x64_linux_gcc_32/libida.so")
		endif()
	endif()
endif()
